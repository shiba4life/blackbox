...
(function() {
  ...
  loadAddress = function() {
    var addressPicker, showPosition;
    if ($('#address_picker').length !== 0) {
      ...
      $(addressPicker).on('addresspicker:selected', function(event, result) {
        ...
        return $('#address_lng').val(result.lng());
      });
    ...
    $('body').on('click', '.get-browser-location', function() {
    ...
    return showPosition = function(position) {
      ...
      return $('#address_lng').val(position.coords.longitude);
    };
  };
...
(function() {
  ...
  loadBatch = function() {
    $('#items').on('keydown', '.batch-item', function(e) {
      if ($('.batch-item').last().val() !== "") {
        return $('.new-item-btn').click();
      }
    });
...
(function() {
  this.onPhotoupload = function(event) {
    var urls;
    urls = $('#item_filepicker_image_urls').val();
    return $.ajax('/preview_images?image_urls=' + urls);
  };
